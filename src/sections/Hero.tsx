...
function Hero({ config: _config, onOpenConsult: _onOpenConsult }: HeroProps) {
  return (
    <section
      id="hero"
      className="mt-2 overflow-hidden rounded-[2rem] border border-[#203562] bg-[radial-gradient(circle_at_top,#10265d_0%,#060d24_58%,#040812_100%)] shadow-[0_24px_70px_rgba(4,10,30,0.45)]"
    >
